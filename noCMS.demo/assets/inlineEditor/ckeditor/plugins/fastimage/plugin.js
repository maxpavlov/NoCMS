                    ...
                    onOk: function (event) {
                        if (editor.data != null) {
                            ...
                            if (Coords) {
                                ...
                                var img = CKEDITOR.dom.element.createFromHtml('<a class="fancybox-image-container" href="' + CurImg.toDataURL('image/png') + '">' +
                                    '<img src="' + previewImg.toDataURL('image/png') + '"  style="float: left; margin-right: 5px;"></a>');
