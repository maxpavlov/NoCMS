...
namespace noCMS.demo.Areas.Admin.FileHandler
{
    public class FilesStatus
    {
        ...
        private readonly string ObligWebPath;
        public readonly string HandlerPath;

        public FilesStatus(IApplicationSettings settings)
        {
            _settings = settings;
            HandlerPath = "/Areas/" + _settings.AdminUrlRoot + "/FileHandler/";
            ObligWebPath = "/assets/ObligContent/";
        }     
        ...
        protected void SetValues(string fileName, int fileLength, string fullPath, bool webPath)
        {
            ...
            thumbnail_url = "/Areas/" + _settings.AdminUrlRoot + "/Content/images/generalFile.png";
