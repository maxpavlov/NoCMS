app.UsersAdminLogic = (function ($) {
    ...
    function UsersManagementViewModel(initData) {
        ...
        self.addUserDialogOptions = {
            ...
            buttons: {
                ...
                'Cancel': function () { self.isAddUserDialogVisible(false); }
            }
        };
    ...
    var constructorFunction = function () {
        ...
        $('#initial-users-and-roles-list').remove();

        app.UsersAdminLogic.ViewModel = new UsersManagementViewModel(initialRolesAndUsersDataObject);
        ko.applyBindings(app.UsersAdminLogic.ViewModel, document.getElementById("users-management-view"));
    };

    return { init: constructorFunction };
}($));

app.UsersAdmin = (function ($) {
    "use strict";
    $(function () {
        app.UsersAdminLogic.init();
